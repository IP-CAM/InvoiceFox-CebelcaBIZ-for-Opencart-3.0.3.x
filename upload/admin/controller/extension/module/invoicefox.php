...
class ControllerExtensionModuleInvoicefox extends Controller {
	...
	public function print_invoice() {   
		...
		$this->load->language('extension/module/invoicefox');
		if(file_exists(DIR_CATALOG."model/extension/invoicefox/hooks.php"))
        {                          
              require_once(DIR_CATALOG."model/extension/invoicefox/hooks.php");
	...
	public function finalize_invoice() {  
		...
		$result = array();
		$this->load->language('extension/module/invoicefox');
		if(file_exists(DIR_CATALOG."model/extension/invoicefox/hooks.php") && $order_id)
        {                          
			  require_once(DIR_CATALOG."model/extension/invoicefox/hooks.php");
              $hooks = new ModelExtensionInvoiceFoxHooks( $this->registry );
